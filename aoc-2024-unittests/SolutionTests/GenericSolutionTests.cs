...
namespace aoc_2024_unittests.SolutionTests
{
    ...
    internal class GenericSolutionTests
    {
        ...
        [TestCase("13", 1, "B")]
        [TestCase("14", 1, "A")]
        //[TestCase("14", 1, "B")] // not really good for testing, leave that
        [TestCase("15", 1, "A")]
        [TestCase("15", 2, "A")]
        [TestCase("15", 2, "B")]
        [TestCase("15", 3, "B")]
        ...
        [TestCase("13", 1, "A", "31623", 1)]
        [TestCase("13", 1, "B", "93209116744825", 1)]
        [TestCase("14", 1, "A", "224969976", 1)]
        //[TestCase("14", 1, "B")]
        [TestCase("15", 1, "A", "1526018", 1)]
        [TestCase("15", 1, "B", "1550677", 2)]
        [TestCase("16", 1, "A", "1526018", 1)]
        [TestCase("16", 1, "B", "1550677", 2)]
        [TestCase("17", 1, "A", "1526018", 1)]
